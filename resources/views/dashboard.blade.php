...
<html class="no-js" lang="en">
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right notification-dropdown" aria-labelledby="notiDropdown">
                                    ...
                                    <div class="notifications-wrap">
                                        ...
                                        <a href="#" class="media">
                                            <span class="d-flex">
                                                <img src="template/img/users/1.jpg" class="rounded-circle" alt="">
                                            </span>
                                            <span class="media-body">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar" src="template/img/user.jpg" alt=""></a>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body chat-box scrollable" style="height:300px;">
                                        <ul class="chat-list">
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="template/img/users/1.jpg" alt="user"></div>
                                            ...
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="template/img/users/2.jpg" alt="user"></div>
                                                <div class="chat-content">
                                            ...
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="template/img/users/3.jpg" alt="user"></div>
                                                <div class="chat-content">
                            ...
                            <div class="col-md-4">
                                <div class="card" style="min-height: 422px;">
                                    ...
                                    <div class="card-body timeline">
                                        <div class="header bg-theme" style="background-image: url('template/img/placeholder/placeimg_400_200_nature.jpg')">
                                ...
                                <table id="advanced_table" class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img src="template/img/users/1.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Tiger Nixon</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="template/img/users/2.jpg" class="table-user-thumb" alt=""></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="template/img/users/3.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Ashton Cox</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="template/img/users/4.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Cedric Kelly</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="template/img/users/5.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Airi Satou</td>
                                            <td>Accountant</td>
                                            <td>Tokyo</td>
                                            <td>33</td>
                        ...
                        <div class="chat-list">
                            <div class="list-group row">
                                ...
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Billy Black">
                                    <figure class="user--online">
                                        <img src="template/img/users/2.jpg" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Billy Black</span>  <span class="username">@billyblack</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Herbert Diaz">
                                    <figure class="user--online">
                                        <img src="template/img/users/3.jpg" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Herbert Diaz</span>  <span class="username">@herbert</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Sylvia Harvey">
                                    <figure class="user--busy">
                                        <img src="template/img/users/4.jpg" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Sylvia Harvey</span>  <span class="username">@sylvia</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item active" data-chat-user="Marsha Hoffman">
                                    <figure class="user--busy">
                                        <img src="template/img/users/5.jpg" class="rounded-circle" alt="">
        ...
        <script src="template/plugins/popper.js/dist/umd/popper.min.js"></script>
        <script src="template/plugins/bootstrap/dist/js/bootstrap.min.js"></script>
        <script src="template/plugins/perfect-scrollbar/dist/perfect-scrollbar.min.js"></script>
        <script src="template/plugins/screenfull/dist/screenfull.js"></script>
        <script src="template/plugins/datatables.net/js/jquery.dataTables.min.js"></script>
        <script src="template/plugins/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
        <script src="template/plugins/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
        <script src="template/plugins/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js"></script>
        <script src="template/plugins/jvectormap/jquery-jvectormap.min.js"></script>
        <script src="template/plugins/jvectormap/tests/assets/jquery-jvectormap-world-mill-en.js"></script>
        <script src="template/plugins/moment/moment.js"></script>
        <script src="template/plugins/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js"></script>
        <script src="template/plugins/d3/dist/d3.min.js"></script>
        <script src="template/plugins/c3/c3.min.js"></script>
        <script src="template/js/tables.js"></script>
        <script src="template/js/widgets.js"></script>
        <script src="template/js/charts.js"></script>
        <script src="template/dist/js/theme.min.js"></script>
